...
public class CrescentroseProjectile extends PersistentProjectileEntity implements IAnimatable, IAnimationTickable {
    private static final TrackedData<Integer> POINTS;
    private static final TrackedData<Integer> MAX_AGE;
    private AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public CrescentroseProjectile(EntityType<? extends PersistentProjectileEntity> entityType, World world) {
        super(entityType, world);
    }

    public CrescentroseProjectile(EntityType<? extends PersistentProjectileEntity> type, World world, LivingEntity owner) {
    ...
    protected SoundEvent getHitSound() {
        return IsekaiSounds.MAGICAL_HIT;
    }
    ...
    static {
        POINTS = DataTracker.registerData(CrescentroseProjectile.class, TrackedDataHandlerRegistry.INTEGER);
        MAX_AGE = DataTracker.registerData(CrescentroseProjectile.class, TrackedDataHandlerRegistry.INTEGER);
    }
}